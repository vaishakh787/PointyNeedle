# PointyNeedle Firmware for ESP32 C3 & S2
...
PointyNeedle v2 or above, with configurable flash settings ability
...
Place the parent directory of this file, containing the `build` folder, into PointyNeedle/app/findmyintegration
